...
test_list_path= [
    [1, "/MultiAnimate/demo/4people/source_frames/0000.jpg","/MultiAnimate/demo/4people/pose", "/MultiAnimate/demo/4people/masks"],
]
...
model_manager.load_models(
    [
        ...
        "checkpoints/Wan2.1-I2V-14B-720P/models_t5_umt5-xxl-enc-bf16.pth",
...
model_manager.load_lora_v2([
            "checkpoints/epoch=23-step=4200-multi.ckpt/output_dir/model-00001-of-00008.safetensors",
            "checkpoints/epoch=23-step=4200-multi.ckpt/output_dir/model-00002-of-00008.safetensors",
            "checkpoints/epoch=23-step=4200-multi.ckpt/output_dir/model-00003-of-00008.safetensors",
            "checkpoints/epoch=23-step=4200-multi.ckpt/output_dir/model-00004-of-00008.safetensors",
            "checkpoints/epoch=23-step=4200-multi.ckpt/output_dir/model-00005-of-00008.safetensors",
            "checkpoints/epoch=23-step=4200-multi.ckpt/output_dir/model-00006-of-00008.safetensors",
            "checkpoints/epoch=23-step=4200-multi.ckpt/output_dir/model-00007-of-00008.safetensors",
            "checkpoints/epoch=23-step=4200-multi.ckpt/output_dir/model-00008-of-00008.safetensors",
            ], lora_alpha=1.0)
...
for path_dir_per in test_list_path:
    ...
    caption = "four person are dancing"
    # video_out_condition = []
    ...
    save_video(video, "/MultiAnimate/outputs/4people.mp4", fps=15, quality=5)
